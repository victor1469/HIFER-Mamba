...
class MambaFrez23Model(SRModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        if hasattr(self.net_g, 'unfrozen') and not self.net_g.unfrozen and current_iter > 10000:
            print(f"[Iter {current_iter}] === Unfreezing last 2 backbone layers ===")
            self.net_g.unfrozen = True
            for layer in self.net_g.layers[-2:]:  
